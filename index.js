    ...
    try {
                        ...
                        await QasimDev.sendMessage(mek.key.remoteJid, {
                            ...
                            contextInfo: {
                                ...
                                forwardedNewsletterMessageInfo: {
                                    ...
                                    newsletterName: '𝙲𝚈𝙱𝙴𝚃 𝙿𝙰𝙽𝙳𝙰 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙱𝙾𝚃',
                                    serverMessageId: -1
                                }
                            }
                        }).catch(console.error);
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (config.pairingNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: +94767233346 (without + or spaces) : `)));
            }
            else {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    await QasimDev.sendMessage(botNumber, {
                        text: ` *🐼 𝙲𝚈𝙱𝙴𝚃 𝙿𝙰𝙽𝙳𝙰 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙱𝙾𝚃 🐼*\n\n\n*🤖ඔබගෙ Wԋαƚʂαρρ Bσƚ සාර්තකව ඩිප්ලොයි වී ඇත...*\n\n\n🤖 𝙱𝙾𝚃 𝙲𝙾𝙽𝙽𝙲𝙴𝚃𝙴𝙳 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈!\n\n⏰ 𝚃𝙸𝙼𝙴: ${new Date().toLocaleString()}\n✅ 𝚂𝚃𝙰𝚃𝚄𝚂: Online and Ready!${ghostStatus}\n\n✅Make sure to join below Group`,
                        contextInfo: {
                            forwardingScore: 1,
                            isForwarded: true,
                            forwardedNewsletterMessageInfo: {
                ...
                printLog('info', `[ ${config.botName || 'CYBER PANDA MD'} ]`);
...
async function main() {
    ...
    printLog('info', 'Starting PANDA MD BOT...');
