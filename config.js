...
const config = {
    ...
    botOwner: process.env.BOT_OWNER || 'Sachith',
    ownerNumber: process.env.OWNER_NUMBER || '94760220052',
    author: process.env.AUTHOR || 'SACHITH',
    packname: process.env.PACKNAME || 'ᴄʏʙᴇʀ ᴘᴀɴᴅᴀ ᴍᴅ',
    ...
    // Links
    channelLink: process.env.CHANNEL_LINK || 'https://chat.whatsapp.com/KySCXYNAz90Im672wK8xyf',
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/GlobalTechInfo/MEGA-MD/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'SACHITH CHANDRA',
    // Session
